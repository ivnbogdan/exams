...
| 5 Design | mark redrawn as SVG from the 2011 banner (discs + cut arrows, Silkscreen wordmark), favicon added; remaining: responsive screenshots, dark mode, OG image, accessibility pass | 2026-09-07 | `src/components/brand-mark.tsx`, `src/app/icon.svg` |
